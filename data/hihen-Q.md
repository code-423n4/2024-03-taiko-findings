...
Total **330 instances** over **29 issues**:

|ID|Issue|Instances|
|:--:|:---|:--:|
| [[L-01]](#l-01-use-increaseallowancedecreaseallowance-instead-of-approvesafeapprove) | Use `increaseAllowance()`/`decreaseAllowance()` instead of `approve()`/`safeApprove()` | 1 |
| [[L-02]](#l-02-events-may-be-emitted-out-of-order-due-to-reentrancy) | Events may be emitted out of order due to reentrancy | 27 |
| [[L-03]](#l-03-nft-doesnt-handle-hard-forks) | NFT doesn't handle hard forks | 1 |
| [[L-04]](#l-04-variables-shadowing-other-definitions) | Variables shadowing other definitions | 35 |
| [[L-05]](#l-05-missing-zero-address-check-in-constructor) | Missing zero address check in constructor | 3 |
| [[L-06]](#l-06-missing-zero-address-check-in-initializer) | Missing zero address check in initializer | 47 |
| [[L-07]](#l-07-function-receivepayable-fallback-does-not-authorize-sender) | Function `receive()`/`payable fallback()` does not authorize sender | 2 |
| [[L-08]](#l-08-revert-on-transfer-to-the-zero-address) | Revert on transfer to the zero address | 8 |
| [[L-09]](#l-09-array-is-pushed-but-not-poped) | Array is `push()`ed but not `pop()`ed | 1 |
| [[L-10]](#l-10-state-variables-not-limited-to-reasonable-values) | State variables not limited to reasonable values | 2 |
| [[L-11]](#l-11-tokenuri-does-not-follow-eip-721) | `tokenURI()` does not follow EIP-721 | 1 |
| [[L-12]](#l-12-consider-implementing-two-step-procedure-for-updating-protocol-addresses) | Consider implementing two-step procedure for updating protocol addresses | 4 |
| [[L-13]](#l-13-unsafe-conversion-from-unsigned-to-signed-values) | Unsafe conversion from unsigned to signed values | 5 |
| [[L-14]](#l-14-downcasting-other-types-to-an-address-can-cause-collisions) | Downcasting other types to an address can cause collisions | 3 |
| [[L-15]](#l-15-vulnerable-versions-of-packages-are-being-used) | Vulnerable versions of packages are being used | 6 |
| [[L-16]](#l-16-inappropriate-storage-gap-size) | Inappropriate storage gap size | 1 |
| [[L-17]](#l-17-constructor--initialization-function-lacks-parameter-validation) | Constructor / initialization function lacks parameter validation | 19 |
| [[L-18]](#l-18-missing-checks-for-address0-when-setting-address-state-variables) | Missing checks for `address(0)` when setting address state variables | 2 |
| [[L-19]](#l-19-unsafe-solidity-low-level-call-can-cause-gas-grief-attack) | Unsafe solidity low-level call can cause gas grief attack | 3 |
| [[L-20]](#l-20-minting-in-a-loop-may-lead-to-a-dos) | Minting in a loop may lead to a DOS | 1 |
| [[L-21]](#l-21-functions-calling-contractsaddresses-with-transfer-hooks-should-be-protected-by-reentrancy-guard) | Functions calling contracts/addresses with transfer hooks should be protected by reentrancy guard | 15 |
| [[L-22]](#l-22-critical-functions-should-be-controlled-by-time-locks) | Critical functions should be controlled by time locks | 19 |
| [[L-23]](#l-23-external-function-calls-within-loops) | External function calls within loops | 9 |
| [[L-24]](#l-24-tokens-may-be-minted-to-the-zero-address) | Tokens may be minted to the zero address | 12 |
| [[L-25]](#l-25-sending-tokens-within-loops) | Sending tokens within loops | 5 |
| [[L-26]](#l-26-use-safecast-to-downcast-safely) | Use `SafeCast` to downcast safely | 37 |
| [[L-27]](#l-27-use-descriptive-constant-instead-of-0-as-a-parameter) | Use descriptive constant instead of 0 as a parameter | 22 |
| [[L-28]](#l-28-code-does-not-follow-the-best-practice-of-check-effects-interaction) | Code does not follow the best practice of check-effects-interaction | 23 |
| [[L-29]](#l-29-unchecked-blocks-with-subtractions-may-underflow) | `unchecked` blocks with subtractions may underflow | 16 |

### Non Critical Issues

Total **2215 instances** over **86 issues**:

|ID|Issue|Instances|
|:--:|:---|:--:|
| [[N-01]](#n-01-import-declarations-should-import-specific-identifiers-rather-than-the-whole-file) | Import declarations should import specific identifiers, rather than the whole file | 179 |
| [[N-02]](#n-02-visibility-of-state-variables-is-not-explicitly-defined) | Visibility of state variables is not explicitly defined | 3 |
| [[N-03]](#n-03-names-of-privateinternal-functions-should-be-prefixed-with-an-underscore) | Names of `private`/`internal` functions should be prefixed with an underscore | 96 |
| [[N-04]](#n-04-names-of-privateinternal-state-variables-should-be-prefixed-with-an-underscore) | Names of `private`/`internal` state variables should be prefixed with an underscore | 18 |
| [[N-05]](#n-05-order-of-functions-does-not-follow-the-solidity-style-guide) | Order of functions does not follow the Solidity Style Guide | 29 |
| [[N-06]](#n-06-the-nonreentrant-modifier-should-occur-before-all-other-modifiers) | The `nonReentrant` `modifier` should occur before all other modifiers | 4 |
| [[N-07]](#n-07-redundant-inheritance-specifier) | Redundant inheritance specifier | 3 |
| [[N-08]](#n-08-use-of-override-is-unnecessary) | Use of `override` is unnecessary | 43 |
| [[N-09]](#n-09-unused-errors) | Unused errors | 1 |
| [[N-10]](#n-10-unused-structs) | Unused `struct`s | 1 |
| [[N-11]](#n-11-add-inline-comments-for-unnamed-parameters) | Add inline comments for unnamed parameters | 11 |
| [[N-12]](#n-12-consider-providing-a-ranged-getter-for-array-state-variables) | Consider providing a ranged getter for array state variables | 1 |
| [[N-13]](#n-13-assembly-blocks-should-have-extensive-comments) | Assembly blocks should have extensive comments | 31 |
| [[N-14]](#n-14-consider-splitting-complex-checks-into-multiple-steps) | Consider splitting complex checks into multiple steps | 1 |
| [[N-15]](#n-15-cast-is-more-restrictive-than-the-type-of-the-variable-being-assigned) | Cast is more restrictive than the type of the variable being assigned | 2 |
| [[N-16]](#n-16-missing-checks-for-empty-bytes-when-updating-bytes-state-variables) | Missing checks for empty bytes when updating bytes state variables | 1 |
| [[N-17]](#n-17-complex-casting) | Complex casting | 2 |
| [[N-18]](#n-18-complex-math-should-be-split-into-multiple-steps) | Complex math should be split into multiple steps | 14 |
| [[N-19]](#n-19-consider-adding-a-blockdeny-list) | Consider adding a block/deny-list | 11 |
| [[N-20]](#n-20-convert-simple-if-statements-to-ternary-expressions) | Convert simple `if`-statements to ternary expressions | 8 |
| [[N-21]](#n-21-contracts-should-each-be-defined-in-separate-files) | Contracts should each be defined in separate files | 5 |
| [[N-22]](#n-22-upper_case-names-should-be-reserved-for-constantimmutable-variables) | UPPER_CASE names should be reserved for `constant`/`immutable` variables | 1 |
| [[N-23]](#n-23-do-not-use-literal-numbers-for-array-indexes) | Do not use literal numbers for array indexes | 37 |
| [[N-24]](#n-24-consider-emitting-an-event-at-the-end-of-the-constructor) | Consider emitting an event at the end of the constructor | 3 |
| [[N-25]](#n-25-empty-function-body-without-comments) | Empty function body without comments | 5 |
| [[N-26]](#n-26-events-are-emitted-without-the-sender-information) | Events are emitted without the sender information | 26 |
| [[N-27]](#n-27-event-is-missing-indexed-fields) | Event is missing `indexed` fields | 28 |
| [[N-28]](#n-28-contract-implements-interface-without-extending-the-interface) | Contract implements interface without extending the interface | 2 |
| [[N-29]](#n-29-imports-could-be-organized-more-systematically) | Imports could be organized more systematically | 31 |
| [[N-30]](#n-30-openzeppelincontracts-should-be-upgraded-to-a-newer-version) | @openzeppelin/contracts should be upgraded to a newer version | 54 |
| [[N-31]](#n-31-lib-openzeppelincontracts-upgradeable-should-be-upgraded-to-a-newer-version) | Lib @openzeppelin/contracts-upgradeable should be upgraded to a newer version | 19 |
| [[N-32]](#n-32-lines-are-too-long) | Lines are too long | 6 |
| [[N-33]](#n-33-expressions-for-constant-values-should-use-immutable-rather-than-constant) | Expressions for constant values should use `immutable` rather than `constant` | 3 |
| [[N-34]](#n-34-consider-moving-duplicated-strings-to-constants) | Consider moving duplicated strings to constants | 69 |
| [[N-35]](#n-35-functions-not-used-internally-could-be-marked-external) | Functions not used internally could be marked external | 65 |
| [[N-36]](#n-36-contracts-containing-only-utility-functions-should-be-made-into-libraries) | Contracts containing only utility functions should be made into libraries | 3 |
| [[N-37]](#n-37-error-names-should-use-capwords-style) | Error names should use CapWords style | 160 |
| [[N-38]](#n-38-functions-should-be-named-in-mixedcase-style) | Functions should be named in mixedCase style | 16 |
| [[N-39]](#n-39-variable-names-for-immutables-should-use-upper_case_with_underscores) | Variable names for `immutable`s should use UPPER_CASE_WITH_UNDERSCORES | 2 |
| [[N-40]](#n-40-order-of-contract-layout-does-not-follow-the-solidity-style-guide) | Order of contract layout does not follow the Solidity Style Guide | 2 |
| [[N-41]](#n-41-consider-adding-validation-of-user-inputs) | Consider adding validation of user inputs | 20 |
| [[N-42]](#n-42-named-imports-of-parent-contracts-are-missing) | Named imports of parent contracts are missing | 71 |
| [[N-43]](#n-43-each-interfaces-should-be-defined-in-a-separate-file) | Each interfaces should be defined in a separate file | 6 |
| [[N-44]](#n-44-libraries-should-be-defined-in-separate-files) | Libraries should be defined in separate files | 3 |
| [[N-45]](#n-45-put-all-system-wide-constants-in-one-file) | Put all system-wide constants in one file | 23 |
| [[N-46]](#n-46-else-block-not-required) | `else`-block not required | 20 |
| [[N-47]](#n-47-large-multiples-of-ten-should-use-scientific-notation) | Large multiples of ten should use scientific notation | 19 |
| [[N-48]](#n-48-high-cyclomatic-complexity) | High cyclomatic complexity | 2 |
| [[N-49]](#n-49-typos) | Typos | 7 |
| [[N-50]](#n-50-consider-bounding-input-array-length) | Consider bounding input array length | 13 |
| [[N-51]](#n-51-unnecessary-casting) | Unnecessary casting | 1 |
| [[N-52]](#n-52-unused-import) | Unused import | 9 |
| [[N-53]](#n-53-unused-named-return) | Unused named return | 10 |
| [[N-54]](#n-54-use-delete-instead-of-assigning-values-to-false) | Use delete instead of assigning values to `false` | 2 |
| [[N-55]](#n-55-consider-using-delete-rather-than-assigning-zero-to-clear-values) | Consider using `delete` rather than assigning zero to clear values | 14 |
| [[N-56]](#n-56-use-the-latest-solidity-version) | Use the latest Solidity version | 81 |
| [[N-57]](#n-57-consider-using-named-function-arguments) | Consider using named function arguments | 23 |
| [[N-58]](#n-58-named-mappings-are-recommended) | Named mappings are recommended | 8 |
| [[N-59]](#n-59-named-returns-are-recommended) | Named returns are recommended | 143 |
| [[N-60]](#n-60-use-typexmax-instead-of-constant-formulas-like-2n) | Use `type(X).max` instead of constant formulas like `2**n` | 2 |
| [[N-61]](#n-61-consider-using-the-using-for-syntax) | Consider using the `using`-`for` syntax | 96 |
| [[N-62]](#n-62-using-underscore-at-the-end-of-variable-name) | Using underscore at the end of variable name | 95 |
| [[N-63]](#n-63-use-a-struct-to-encapsulate-multiple-function-parameters) | Use a struct to encapsulate multiple function parameters | 8 |
| [[N-64]](#n-64-returning-a-struct-instead-of-a-bunch-of-variables-is-better) | Returning a struct instead of a bunch of variables is better | 15 |
| [[N-65]](#n-65-events-that-mark-critical-parameter-changes-should-contain-both-the-old-and-the-new-value) | Events that mark critical parameter changes should contain both the old and the new value | 4 |
| [[N-66]](#n-66-contract-variables-should-have-comments) | Contract variables should have comments | 41 |
| [[N-67]](#n-67-missing-event-when-a-state-variables-is-set-in-constructor) | Missing event when a state variables is set in constructor | 2 |
| [[N-68]](#n-68-empty-bytes-check-is-missing) | Empty bytes check is missing | 13 |
| [[N-69]](#n-69-dont-define-functions-with-the-same-name-in-a-contract) | Don't define functions with the same name in a contract | 14 |
| [[N-70]](#n-70-interface-files-should-not-use-fixed-compiler-versions) | Interface files should not use fixed compiler versions | 11 |
| [[N-71]](#n-71-assembly-block-creates-dirty-bits) | Assembly block creates dirty bits | 5 |
| [[N-72]](#n-72-multiple-mappings-with-same-keys-can-be-combined-into-a-single-struct-mapping-for-readability) | Multiple mappings with same keys can be combined into a single struct mapping for readability | 8 |
| [[N-73]](#n-73-inconsistent-spacing-in-comments) | Inconsistent spacing in comments | 44 |
| [[N-74]](#n-74-missing-event-for-critical-changes) | Missing event for critical changes | 7 |
| [[N-75]](#n-75-non-assembly-method-available) | Non-assembly method available | 3 |
| [[N-76]](#n-76-duplicated-requirerevert-checks-should-be-refactored) | Duplicated `require()`/`revert()` checks should be refactored | 23 |
| [[N-77]](#n-77-consider-adding-emergency-stop-functionality) | Consider adding emergency-stop functionality | 27 |
| [[N-78]](#n-78-missing-checks-for-uint-state-variable-assignments) | Missing checks for uint state variable assignments | 8 |
| [[N-79]](#n-79-use-the-modern-upgradeable-contract-paradigm) | Use the Modern Upgradeable Contract Paradigm | 3 |
| [[N-80]](#n-80-large-or-complicated-code-bases-should-implement-invariant-tests) | Large or complicated code bases should implement invariant tests | 1 |
| [[N-81]](#n-81-the-default-value-is-manually-set-when-it-is-declared) | The default value is manually set when it is declared | 13 |
| [[N-82]](#n-82-contracts-should-have-all-publicexternal-functions-exposed-by-interfaces) | Contracts should have all `public`/`external` functions exposed by `interface`s | 28 |
| [[N-83]](#n-83-top-level-declarations-should-be-separated-by-at-least-two-lines) | Top-level declarations should be separated by at least two lines | 167 |
| [[N-84]](#n-84-consider-adding-formal-verification-proofs) | Consider adding formal verification proofs | 81 |
| [[N-85]](#n-85-use-scopes-sparingly) | Use scopes sparingly | 12 |
| [[N-86]](#n-86-prevent-re-setting-a-state-variable-with-the-same-value) | Prevent re-setting a state variable with the same value | 13 |
...
### [L-03] NFT doesn't handle hard forks
...
### [L-04] Variables shadowing other definitions
...
### [L-06] Missing zero address check in initializer
...
### [L-07] Function `receive()`/`payable fallback()` does not authorize sender
...
### [L-09] Array is `push()`ed but not `pop()`ed
...
### [L-10] State variables not limited to reasonable values
...
### [L-11] `tokenURI()` does not follow EIP-721
...
### [L-13] Unsafe conversion from unsigned to signed values
...
### [L-14] Downcasting other types to an address can cause collisions
...
### [L-16] Inappropriate storage gap size
...
### [L-17] Constructor / initialization function lacks parameter validation
...
### [L-20] Minting in a loop may lead to a DOS
...
### [L-21] Functions calling contracts/addresses with transfer hooks should be protected by reentrancy guard
...
### [L-22] Critical functions should be controlled by time locks
...
### [L-26] Use `SafeCast` to downcast safely
...
### [L-27] Use descriptive constant instead of 0 as a parameter
...
### [L-28] Code does not follow the best practice of check-effects-interaction
...
### [L-29] `unchecked` blocks with subtractions may underflow
...
### [N-05] Order of functions does not follow the Solidity Style Guide
...
### [N-06] The `nonReentrant` `modifier` should occur before all other modifiers
...
### [N-07] Redundant inheritance specifier
...
### [N-13] Assembly blocks should have extensive comments
...
### [N-15] Cast is more restrictive than the type of the variable being assigned
...
### [N-16] Missing checks for empty bytes when updating bytes state variables
...
### [N-18] Complex math should be split into multiple steps
...
### [N-20] Convert simple `if`-statements to ternary expressions
...
### [N-21] Contracts should each be defined in separate files
...
### [N-22] UPPER_CASE names should be reserved for `constant`/`immutable` variables
...
### [N-23] Do not use literal numbers for array indexes
...
### [N-24] Consider emitting an event at the end of the constructor
...
### [N-25] Empty function body without comments
...
### [N-28] Contract implements interface without extending the interface
...
### [N-29] Imports could be organized more systematically
...
### [N-31] Lib @openzeppelin/contracts-upgradeable should be upgraded to a newer version
...
### [N-34] Consider moving duplicated strings to constants
...
### [N-35] Functions not used internally could be marked external
...
### [N-36] Contracts containing only utility functions should be made into libraries
...
### [N-37] Error names should use CapWords style
...
### [N-38] Functions should be named in mixedCase style
...
### [N-39] Variable names for `immutable`s should use UPPER_CASE_WITH_UNDERSCORES
...
### [N-40] Order of contract layout does not follow the Solidity Style Guide
...
### [N-41] Consider adding validation of user inputs
...
### [N-42] Named imports of parent contracts are missing
...
### [N-43] Each interfaces should be defined in a separate file
...
### [N-44] Libraries should be defined in separate files
...
### [N-45] Put all system-wide constants in one file
...
### [N-47] Large multiples of ten should use scientific notation
...
### [N-50] Consider bounding input array length
...
### [N-56] Use the latest Solidity version
...
### [N-57] Consider using named function arguments
...
### [N-58] Named mappings are recommended
...
### [N-59] Named returns are recommended
...
### [N-60] Use `type(X).max` instead of constant formulas like `2**n`
...
### [N-61] Consider using the `using`-`for` syntax
...
### [N-62] Using underscore at the end of variable name
...
### [N-65] Events that mark critical parameter changes should contain both the old and the new value
...
### [N-66] Contract variables should have comments
...
### [N-67] Missing event when a state variables is set in constructor
...
### [N-68] Empty bytes check is missing
...
### [N-69] Don't define functions with the same name in a contract
...
### [N-70] Interface files should not use fixed compiler versions
...
### [N-71] Assembly block creates dirty bits
...
### [N-72] Multiple mappings with same keys can be combined into a single struct mapping for readability
...
### [N-73] Inconsistent spacing in comments
...
### [N-74] Missing event for critical changes
...
### [N-75] Non-assembly method available
...
### [N-76] Duplicated `require()`/`revert()` checks should be refactored
...
### [N-78] Missing checks for uint state variable assignments
...
### [N-79] Use the Modern Upgradeable Contract Paradigm
...
### [N-80] Large or complicated code bases should implement invariant tests
...
### [N-81] The default value is manually set when it is declared
...
### [N-82] Contracts should have all `public`/`external` functions exposed by `interface`s
...
### [N-83] Top-level declarations should be separated by at least two lines
...
### [N-84] Consider adding formal verification proofs
...
### [N-86] Prevent re-setting a state variable with the same value
