...
| [GAS&#x2011;003](#GAS003-operator->=/<=-costs-less-gas-than-operator->/<) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 130 | 390 |
...
| [GAS&#x2011;009](#GAS009-avoid-contract-existence-checks-by-using-low-level-calls) | Avoid contract existence checks by using low-level calls | 47 | 4,700 |
| [GAS&#x2011;010](#GAS010-avoid-unnecessary-public-variables) | Avoid Unnecessary Public Variables | 44 | 968,000 |
...
| [GAS&#x2011;018](#GAS018-small-uints-can-be-packed-to-save-gas) | Small `uint`s can be packed to save gas | 89 | 1,851,200 |
...
| [GAS&#x2011;022](#GAS022-consider-using-soladys-gas-optimized-lib-for-math) | Consider using Solady's gas optimized lib for Math | 77 | - |
| [GAS&#x2011;023](#GAS023-constructors-can-be-marked-payable) | Constructors can be marked `payable` | 3 | 63 |
| [GAS&#x2011;024](#GAS024-counting-down-in-for-statements-is-more-gas-efficient) | Counting down in `for` statements is more gas efficient | 47 | - |
| [GAS&#x2011;025](#GAS025-variables-should-be-declared-outside-of-loops) | Variables should be declared outside of loops | 57 | 855 |
| [GAS&#x2011;026](#GAS026-do-not-calculate-constants) | Do not calculate constants | 2 | - |
| [GAS&#x2011;027](#GAS027-optimize-gas-by-using-do-while-loops) | Optimize gas by using Do-While loops | 49 | 12,495 |
...
| [GAS&#x2011;029](#GAS029-consider-moving-duplicated-require/revert-checks-to-a-modifier-or-function) | Consider moving duplicated `require()/revert()` checks to a modifier or function | 792 | - |
...
| [GAS&#x2011;032](#GAS032-fixed-size-arrays-are-cheaper-than-dynamic-size-arrays) | Fixed-size arrays are cheaper than dynamic-size arrays | 69 | - |
| [GAS&#x2011;033](#GAS033-optimize-names-to-save-gas) | Optimize names to save gas | 38 | 4,864 |
| [GAS&#x2011;034](#GAS034-functions-guaranteed-to-revert-when-called-by-normal-users-can-be-marked-payable) | Functions guaranteed to revert when called by normal users can be marked `payable` | 41 | 861 |
| [GAS&#x2011;035](#GAS035-initializers-can-be-marked-payable) | Initializers can be marked `payable` | 24 | 504 |
| [GAS&#x2011;036](#GAS036-inline-modifiers-that-are-only-used-once-to-save-gas) | Inline `modifier`s that are only used once, to save gas | 340 | - |
...
| [GAS&#x2011;073](#GAS073-use-arrayunsafeaccess-to-avoid-repeated-array-length-checks) | Use `Array.unsafeAccess()` to avoid repeated array length checks | 54 | 113,400 |
...
<details>
<summary><i>There are 130 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 47 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 44 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 89 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 77 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 57 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 49 instances (click to view)</i></summary>
...
294         }
```
([140](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L140-L144), [152](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L152-L156), [158](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L158-L162), [174](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L174-L178), [273](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L273-L277), [283](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L283-L287), [290](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L290-L294))
...
61         }
```
([48](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/X509DateUtils.sol#L48-L54), [59](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/X509DateUtils.sol#L59-L61))
...
<details>
<summary><i>There are 792 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 69 instances (click to view)</i></summary>
...
```
([75](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/AutomataDcapV3Attestation.sol#L75), [90](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/AutomataDcapV3Attestation.sol#L90), [230](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/AutomataDcapV3Attestation.sol#L230-L231), [248](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/AutomataDcapV3Attestation.sol#L248), [415](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/AutomataDcapV3Attestation.sol#L415))
...
```
([198](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/lib/PEMCertChainLib.sol#L198))
...
```
([276](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/lib/QuoteV3Auth/V3Parser.sol#L276))
...
```
([53](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/ERC20Airdrop.sol#L53))
...
```
([78](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/ERC20Airdrop2.sol#L78))
...
```
([49](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/ERC721Airdrop.sol#L49-L50))
...
```
([67](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/MerkleClaimable.sol#L67), [78](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/MerkleClaimable.sol#L78))
...
```
([17](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/trie/MerkleTrie.sol#L17), [53](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/trie/MerkleTrie.sol#L53), [70](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/trie/MerkleTrie.sol#L70), [205](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/trie/MerkleTrie.sol#L205))
...
```
([22](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/trie/SecureMerkleTrie.sol#L22), [40](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/trie/SecureMerkleTrie.sol#L40))
...
```
([163](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/ERC1155Vault.sol#L163-L164), [217](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/ERC1155Vault.sol#L217-L218))
...
```
([163](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/ERC721Vault.sol#L163))
...
```
([90](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/SgxVerifier.sol#L90), [100](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/SgxVerifier.sol#L100), [132](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/SgxVerifier.sol#L132), [196](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/SgxVerifier.sol#L196))
...
<details>
<summary><i>There are 41 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 340 instances (click to view)</i></summary>
...
// @audit used only once @ contracts/team/airdrop/MerkleClaimable.sol#67
...
// @audit used only once @ contracts/tokenvault/BridgedERC20.sol#85
...
<details>
<summary><i>There are 163 instances (click to view)</i></summary>
...
```
([10](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/interfaces/IAttestation.sol#L10-L12))
...
592     }
```
([115](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L115-L152), [392](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L392-L399), [403](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L403-L408), [417](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L417-L446), [477](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L477-L508), [577](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L577-L592))
...
```
([109](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/IBridge.sol#L109-L112), [145](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/IBridge.sol#L145))
...
233     }
```
([176](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/TimelockTokenPool.sol#L176-L199), [225](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/TimelockTokenPool.sol#L225-L233))
...
66     }
```
([47](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BaseVault.sol#L47-L56), [58](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BaseVault.sol#L58-L66))
...
224     }
```
([195](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/SgxVerifier.sol#L195-L224))
...
<details>
<summary><i>There are 81 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 50 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 175 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 190 instances (click to view)</i></summary>
...
105     {
```
([39](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/TaikoL1.sol#L39-L40), [96](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/TaikoL1.sol#L96-L105))
...
```
([38](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/TaikoToken.sol#L38-L41), [95](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/TaikoToken.sol#L95-L102))
...
57  
```
([57](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/provers/GuardianProver.sol#L57))
...
71         }
```
([63](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/provers/Guardians.sol#L63-L65), [68](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/provers/Guardians.sol#L68-L71))
...
58  
```
([58](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/tiers/DevnetTierProvider.sol#L58))
...
72  
```
([72](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/tiers/MainnetTierProvider.sol#L72))
...
73  
```
([73](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L1/tiers/TestnetTierProvider.sol#L73))
...
72         }
```
([46](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/CrossChainOwned.sol#L46-L48), [70](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/CrossChainOwned.sol#L70-L72))
...
277             }
```
([38](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/TaikoL2.sol#L38-L41), [82](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/TaikoL2.sol#L82-L84), [91](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/TaikoL2.sol#L91-L100), [116](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/TaikoL2.sol#L116-L121), [141](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/TaikoL2.sol#L141-L143), [275](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/L2/TaikoL2.sol#L275-L277))
...
411             }
```
([237](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/AutomataDcapV3Attestation.sol#L237-L239), [406](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/AutomataDcapV3Attestation.sol#L406-L411))
...
139             }
```
([134](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/lib/PEMCertChainLib.sol#L134-L139))
...
220         }
```
([77](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/lib/QuoteV3Auth/V3Parser.sol#L77-L86), [94](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/lib/QuoteV3Auth/V3Parser.sol#L94-L99), [218](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/lib/QuoteV3Auth/V3Parser.sol#L218-L220))
...
272         }
```
([137](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L137-L139), [167](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L167-L172), [270](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/automata-attestation/utils/RsaVerify.sol#L270-L272))
...
504         }
```
([41](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L41-L44), [93](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L93-L99), [124](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L124-L126), [250](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L250-L256), [260](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L260-L262), [269](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L269-L287), [321](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L321-L323), [405](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L405-L407), [429](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L429-L445), [490](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/bridge/Bridge.sol#L490-L504))
...
279         }
```
([91](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/TimelockTokenPool.sol#L91-L95), [274](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/TimelockTokenPool.sol#L274-L279))
...
74  
```
([74](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/ERC20Airdrop.sol#L74))
...
```
([40](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/ERC20Airdrop2.sol#L40-L42), [97](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/ERC20Airdrop2.sol#L97-L100))
...
64  
```
([64](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/team/airdrop/ERC721Airdrop.sol#L64))
...
185             );
```
([182](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/rlp/RLPReader.sol#L182-L185))
...
192                 }
```
([155](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/thirdparty/optimism/trie/MerkleTrie.sol#L155-L192))
...
68  
```
([68](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BaseVault.sol#L68))
...
```
([102](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BridgedERC1155.sol#L102-L113))
...
```
([38](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BridgedERC20.sol#L38-L40), [108](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BridgedERC20.sol#L108-L113))
...
47         }
```
([35](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BridgedERC20Base.sol#L35-L37), [45](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BridgedERC20Base.sol#L45-L47))
...
```
([104](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/BridgedERC721.sol#L104-L107))
...
25         }
```
([20](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/LibBridgedToken.sol#L20-L25))
...
52  
```
([52](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/tokenvault/adapters/USDCAdapter.sol#L52))
...
36  
```
([36](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/GuardianVerifier.sol#L36))
...
```
([35](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/SgxVerifier.sol#L35-L36), [69](https://github.com/code-423n4/2024-03-taiko/blob/main/packages/protocol/contracts/verifiers/SgxVerifier.sol#L69-L72))
...
<details>
<summary><i>There are 137 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 60 instances (click to view)</i></summary>
...
// @audit _serialNumIsRevoked is read 2 times
88     function removeRevokedCertSerialNum( 
89         uint256 index,
90         bytes[] calldata serialNumBatch
91     )
...
// @audit sharedVault is read 2 times
...
// @audit claimEnd is read 2 times
88     function withdraw(address user) external ongoingWithdrawals { 

// @audit withdrawalWindow is read 2 times
// @audit claimEnd is read 3 times
104     function getBalance(address user) 
105         public
106         view
107         returns (uint256 balance, uint256 withdrawableAmount)
...
// @audit merkleRoot is read 2 times
// @audit claimStart is read 2 times
// @audit claimEnd is read 2 times
67     function _verifyClaim(bytes memory data, bytes32[] calldata proof) internal ongoingClaim { 
```
...
// @audit instances is read 3 times
100     function deleteInstances(uint256[] calldata _ids) 
101         external
102         onlyFromOwnerOrNamed("rollup_watchdog")
103     {

// @audit nextInstanceId is read 3 times
195     function _addInstances( 
196         address[] memory _instances,
197         bool instantValid
198     )
...
<details>
<summary><i>There are 189 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 54 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 51 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 56 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 70 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 66 instances (click to view)</i></summary>
...
<details>
<summary><i>There are 86 instances (click to view)</i></summary>
